/**
 * join string array function.
 * @param array - The array to join.
 * @param separator - The separator to join the array.
 * @example
 * joinStringArray(["apple", "banana", "cherry"], ", ") // "apple, banana, cherry"
 * joinStringArray(["apple", "banana", ""], "") // "applebananacherry"
 * joinStringArray([1, 2, 3], ", ") // "1, 2, 3"
