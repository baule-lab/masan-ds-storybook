...
const SIDEBAR_WIDTH = 'calc(16.2rem * var(--scale-compact))';
const SIDEBAR_WIDTH_MOBILE = 'calc(18rem * var(--scale-compact))';
const SIDEBAR_WIDTH_ICON = 'calc(3rem * var(--scale-compact))';
